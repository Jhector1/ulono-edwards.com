      ...
      >
        ...
        <div className="relative container mx-auto px-4 py-32 text-center text-white">
          <h1 className="text-5xl font-bold mb-4">
            Uloño
            <br />
            <span className="text-[#E85E2D]">
              Geolinguistic Praxis Services
            </span>
          </h1>
  ...
  "
      ...
      >
        <h2 className="text-3xl font-semibold mb-6">
          About Dr. Edward C. Davis IV
        </h2>
        <p className="mb-4">
          Born in Chicago with ancestral roots tracing back to the Underground
          Railroad and the Great Migration, Dr. Davis is a Melungeon Maroon
          descendant whose scholarly journey spans New York University, UC
          Berkeley, and the University of Cambridge.
        </p>
        <p className="mb-4">
          As a global sociocultural anthropologist, licensed K12 teacher, and
          tenured professor, he has taught Africana Studies, Anthropology,
          History, and French at institutions in the US and the Democratic
          Republic of Congo.
        </p>
      </section>
      ...
      <section id="services" className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="p-6 bg-white rounded-xl shadow-lg">
            ...
            <p>
              Customized antiracist trainings for governments, educational
          ...
          <div className="p-6 bg-white rounded-xl shadow-lg">
            ...
            <p>
              Engaging talks on Uloño philosophy, African Diaspora, and
          ...
          <div className="p-6 bg-white rounded-xl shadow-lg">
            ...
            <p>
              Guidance on heritage tourism, cultural preservation, and community
              development.
            </p>
          </div>
          <div className="p-6 bg-white rounded-xl shadow-lg">
      ...
      >
        ...
        <p className="mb-6">
          Book Dr. Davis for consultations, trainings, and speaking engagements
          worldwide.
        </p>
        <Link href="/contact">
